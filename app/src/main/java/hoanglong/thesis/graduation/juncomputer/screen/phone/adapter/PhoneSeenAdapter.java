...
public class PhoneSeenAdapter extends RecyclerView.Adapter<PhoneSeenAdapter.ItemPhoneViewHolder> {

    private List<ItemSeen> mPhoneProducts;
    private LayoutInflater mLayoutInflater;
    private OnClickProductListener mOnClickProductListener;

    public PhoneSeenAdapter(List<ItemSeen> phoneProducts, OnClickProductListener onClickProductListener) {
    ...
    public void onBindViewHolder(@NonNull ItemPhoneViewHolder itemPhoneViewHolder, int i) {
        ItemSeen itemPhoneProduct = mPhoneProducts.get(i);
    ...
    public interface OnClickProductListener {
        void onClickItemSeenProduct(ItemSeen itemPhoneProduct);
    }
    ...
    public static class ItemPhoneViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private ItemSeen mItemPhoneProduct;
...
//            mTextInfo = itemView.findViewById(R.id.text_info_product);
        ...
        public void bindData(ItemSeen itemPhoneProduct) {
        ...
        public void onClick(View view) {
            mListener.onClickItemSeenProduct(mItemPhoneProduct);
        }
    }
}
