...
public class NewAddressFragment extends BaseFragment implements View.OnClickListener {
    ...
    private OnListenerPayment mOnListenerPayment;
    private AddressUser mAddressUser;
    private boolean isUpdate;

    public static NewAddressFragment newInstance(AddressUser addressUser) {
    ...
    public void onAttach(Context context) {
        ...
        mOnListenerPayment = (OnListenerPayment) context;
    }
    ...
    private void saveAddress(final AddressUser addressUser) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                mOnListenerPayment.onUpdateAddress();
            }
        }, 1000);
    }
